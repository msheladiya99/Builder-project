...
// ── FLATS STORE ──
export const useFlatStore = create<any>((set) => ({
  flats: [],
  selectedFlat: null,
  loading: false,
  error: null,
...
// ── INVENTORY STORE ──
export const useInventoryStore = create<any>((set) => ({
  stock: [],
  vendors: [],
  purchaseOrders: [],
  loading: false,
...
// ── LABOUR STORE ──
export const useLabourStore = create<any>((set) => ({
  workers: [],
  contractors: [],
  loading: false,
...
// ── ACCOUNTING STORE ──
export const useAccountingStore = create<any>((set) => ({
  accounts: [],
  expenses: [],
  journals: [],
  loading: false,
